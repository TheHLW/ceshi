<?php /*a:2:{s:73:"D:\phpstudy\PHPTutorial\WWW\tpcms\application\admin\view\index\index.html";i:1539764547;s:68:"D:\phpstudy\PHPTutorial\WWW\tpcms\application\admin\view\layout.html";i:1539764547;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="stylesheet" href="/tpcms/public/static/admin/css/global.css">
...
<body class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <a href="javascript:;" class="hideMenu icon iconfont  icon-liebiao"></a>
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item"><a href="javascript:;"><img src="/tpcms/public/static/admin/img/avatar.png" class="layui-nav-img userAvatar" width="35" height="35"><?php echo htmlentities($userInfo['username']); ?></a>
                    <dl class="layui-nav-child">
        ...
        <div class="layui-body" id="B_frame">
            <div class="layui-tab mag0" id="top_tabs_box" lay-filter="Tab">
                ...
                <ul class="layui-tab-title top_tab" id="B_history">
                    <li class="layui-this" lay-id="default"><i class="layui-icon layui-icon-home"></i>&nbsp;后台首页
                    </li>
                </ul>
                <div class="tab-right">
                    ...
                    <ul class="layui-nav closeBox">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a href="javascript:;" class="refresh" id="J_refresh"><i class="layui-icon layui-icon-refresh"></i>&nbsp;刷新当前</a></dd>
